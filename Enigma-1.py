...
def keydegen(key): 
    ...
    #возврат ключа в первоначальную форму
...
def encrypt():
    ...
    #работа с рандомной генерацией ключа
    final = " "
    text = input("Введите текст: ")
    #генерация компонентов ключа
...
#основная функция #2 (дешифрование)
